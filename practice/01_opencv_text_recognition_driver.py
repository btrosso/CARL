...
# ap.add_argument("-i", "--input", required=True, default=image_input_path,
#                 help="path to input directory of images")
ap.add_argument("-i", "--input", type=str, default=image_input_path,
                help="path to input directory of images")
ap.add_argument("-c", "--clear-border", type=int, default=clear_border,
...
ap.add_argument("-d", "--debug", type=int, default=debug,
