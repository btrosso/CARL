...
if __name__ == "__main__":
    evaluate_yolo_accuracy(
        gt_dir="/Users/brosso/Documents/personal_code/CARL/old/v3/vehicle_axle_dataset/labels/val",
        pred_dir="/Users/brosso/Documents/personal_code/CARL/old/v3/runs/predict/predict/labels"  # adjust if different
    )
